...
<center><font size='4px'>Find Doctors</font></center></div>
            ...
            if(isset($_POST['find']) || isset($_REQUEST['id'])  )
			{
				...
				if(isset($_POST['find']))
				{$user_id=$_POST['docid'];
			echo"<a href='clinicfinddoc.php'class='btn btn-info'>back</a><br/>";
			
				}
				else
				{$user_id=$_REQUEST['id'];
				echo"<a href='clinicviewalldoc.php' class='btn btn-info'>back</a><br/>";
echo"<br>";			
			}
			...
			echo"<form action='bookappointment_clinic.php' method='post'>
			<div class='row'>
...
";
		...
		else
		{
			...
			echo"<form action='clinicfinddoc.php' method='post'>
