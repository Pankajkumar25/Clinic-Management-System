...
$sql1="SELECT id,name FROM patient limit $offset,$size ";
...
<a href='clinicview_patient.php?id=$row_data[id]' class='btn btn-info'>View Profile</a></td></tr>";
...
{
$lastpageno=$pageno-1;
echo "<a href='clinicviewall.php?pageno=$lastpageno' class='btn btn-info'>Previous</a>";
}
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";

for($i=0,$j=1;$i<$total_pages;$i++,$j++)
{
	echo "<a href='clinicviewall.php?pageno=$i'>$j</a> &nbsp;&nbsp;";
}
...
{
$pageno++;
echo "<a href='clinicviewall.php?pageno=$pageno' class='btn btn-info'>Next</a>";
}
echo "</center>";
