...
if(isset($_REQUEST['act1']))
{
	...
	{		
		...
		echo "<tr><th>Address:</th><td>$row_data[2]</td></tr>";
		echo "<tr><th>Gender:</th><td>$row_data[3]</td></tr>";
		echo "<tr><th>Specialist:</th><td>$row_data[4]</td></tr>";
		echo "<tr><th>Working Days:</th><td>$row_data[5]</td></tr>";
