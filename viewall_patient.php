...
function edit_msg()
{
	return confirm("Are you sure to Book Appointment");
...
<center><font size='4px'>Find Doctors</font></center></div>
            ...
            if(isset($_POST['find']) || isset($_REQUEST['id'])  )
			{
				...
				if(isset($_POST['find']))
				{$user_id=$_POST['docid'];
			echo"<a href='viewalldoc_patient.php'class='btn btn-info'>back</a><br/>";
...
echo"<br>";			
			...
			<div class='col-md-2'>
			<input type='submit' value='Book Appointment' onclick='return edit_msg()' class='btn btn-success'/>
			</div>
			</div>
			</form>
			</br>
...
";
		...
		else
		{
			...
			echo"<form action='viewall_patient.php.php' method='post'>
