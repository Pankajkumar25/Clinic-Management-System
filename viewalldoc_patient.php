...
<a href='viewall_patient.php?id=$row_data[id]' class='btn btn-info'>View Profile</a></div></td></tr>";
...
{
$lastpageno=$pageno-1;
echo "<a href='viewalldoc_patient.php.php?pageno=$lastpageno' class='btn btn-info'>Previous</a>";
}
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";

for($i=0,$j=1;$i<$total_pages;$i++,$j++)
{
	echo "<a href='viewalldoc_patient.php.php?pageno=$i'>$j</a> &nbsp;&nbsp;";
}
...
{
$pageno++;
echo "<a href='viewalldoc_patient.php.php?pageno=$pageno' class='btn btn-info'>Next</a>";
}
echo "</center>";
